...
void setId(uint32_t* message, uint32_t data) {
  *message = (*message & 0x00ffffff) | (data << 24); 
}

void setNodeType(uint32_t* message, uint32_t data) {
  *message = (*message & 0xff0fffff) | (data << 20);
}

void setData(uint32_t* message, uint32_t data) {
  *message = (*message & data_mask) | (data << 10);
}
